...
export function TechnicalResponseScreen() {
  ...
  async function autofillResponseTemplate() {
    ...
    const documentFilename = "tech-response.md";
    try {
  ...
  function saveDocument() {
    ...
    const regularFilename = `Tech Response for ${candidateName} by ${interviewerName}`;
    ...
    nextHtmlDoc = nextHtmlDoc.replace("$title", "Technical Interview Response");
